...
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_SOFT_YELLOW = SET_BG_COLOR + "229m";
    public static final String SET_BG_COLOR_RED = SET_BG_COLOR + "160m";
    public static final String SET_BG_COLOR_SOFT_GREEN = SET_BG_COLOR + "42m";      // Normal green
    public static final String SET_BG_COLOR_DARK_GREEN = "\u001B[48;5;34m";
    ...
    public static final String SET_BG_COLOR_LIGHT_MAGENTA = SET_BG_COLOR + "105m";
